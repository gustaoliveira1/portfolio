    ...
    <main className="min-h-full">
      <div className="max-w-[786px] mx-auto p-6 pt-20">
        ...
        <div className="text-black/80 text-xl space-y-6">
          <p>
            Sou um entusiasta da tecnologia desde muito cedo e, atualmente, aos
            19 anos, estou cursando Análise e Desenvolvimento de Sistemas. No
          ...
          <p>
            ...
            transformar ideias em experiências digitais incríveis. Minha
            expertise em design me permite criar interfaces elegantes e usáveis.
            Meu trabalho resulta em produtos digitais que cativam, simplificam e
            conectam pessoas, proporcionando uma experiência inesquecível!
          </p>
          <p>
            Sinto-me entusiasmado com as oportunidades que surgem para
            compartilhar meus conhecimentos e contribuir em projetos
            empolgantes. Estou em constante jornada de aprendizado e evolução,
            buscando aperfeiçoar minhas habilidades técnicas e expandir meu
            conhecimento pessoal na área em constante desenvolvimento da
            tecnologia.
          </p>
        </div>
      </div>
